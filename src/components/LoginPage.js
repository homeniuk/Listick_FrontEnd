...
function LoginPage() {
    ...
    return (
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div className="mt-4">
              <button onClick={()=>dispatch(Login())} className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
            </div>
         
      
          <p className="mt-6 text-center text-sm">
            <a className="font-semibold leading-8 text-indigo-600 hover:text-indigo-500">Or register your account</a>
          </p>
        </div>
      </div>
    );
